...
Automação em Google Apps Script para a organização de documentos em editais no Google Drive.
...
​Para reutilizar este código no seu processo, você será necessário alterar as variáveis de configuração no início do script:
